...
class _ObatCrudPageState extends State<ObatCrudPage> {
  ...
  Future<void> simpanObat({String? id}) async {
    ...
    final data = {
      ...
      'jenis_obat': jenisObat, // lowercase
    ...
    try {
      id == null
          ? await obatRef.add(data)
          : await obatRef.doc(id).update(data);

      resetForm();
      if (mounted) Navigator.pop(context);
    } catch (e) {
      _msg('Gagal menyimpan obat');
    }
  }
      ...
      body: StreamBuilder<QuerySnapshot>(
        ...
        builder: (_, s) {
          ...
          if (s.data!.docs.isEmpty) {
            return const Center(child: Text('Data obat kosong'));
          }
  ...
  Widget dropdown(
    ...
    return DropdownButtonFormField<String>(
      value: items.contains(value) ? value : null, // 🔥 ANTI CRASH
  ...
  Widget info(String l, String v) =>
      Padding(padding: const EdgeInsets.only(bottom: 4), child: Text('$l: $v'));
